            ...
            <div class="col-6">
                <div class="d-flex justify-content-start">
                    <form class="" action="add" method="POST">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="contents is required">
                            <textarea class="input100" name="contents" placeholder="Your contents..."></textarea>
                        </div>
